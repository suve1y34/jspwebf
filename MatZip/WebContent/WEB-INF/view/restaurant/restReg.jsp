...
<div id="sectionContainerCenter">
	<div>
		<form id="frm" action="/restaurant/restRegProc" method="post" onsubmit="return chkFrm()">
			<div><input class="focus" type="text" name="nm" placeholder="가게명"></div>
			<div>
				<input class="focus" type="text" name="addr" placeholder="주소" onkeyup="changeAddr()" style="width:200px;">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=91a1adc940bfd01e9782c38f5c083003&libraries=services"></script>
	<script>
		function chkFrm() {
